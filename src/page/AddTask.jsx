  ...
  function hanadleSave() {
    ...
    if (!errorSet.date) {
      ...
      if (today > currentDate) {
        error.date = true;
        errorMsg.date =
          "Unfortunatly we dont habe time machine to go to the past";
        errorSet.date = 1;
        errorSet.isError = true;
        error.isError = true;
      }
    ...
    <div className="flex flex-col px-60 gap-8 pt-5">
      <div className="flex flex-col gap-5">
        ...
        <div className="flex justify-between">
          <div className=" flex flex-col gap-2">
            <label htmlFor="date" className="font-semibold text-[15px]">
              Due Date
            </label>
            <input
              type="date"
            ...
            />
            {error.date && (
              <Alert severity="error" className="w-65" variant="outlined">
                {errorMsg.date}
              </Alert>
            )}
          </div>
          <div className="flex flex-col gap-2">
            <label htmlFor="priority" className="font-semibold text-[15px] ">
              Priority
            </label>
            <select
              name="priority"
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="subTask" className="font-semibold text-[15px]">
            Subtasks
          </label>
          <textarea
            name="subTask"
      ...
      <div className="self-end flex gap-5">
        <Button
          ...
          className="bg-gray-200 text-black rounded-[12px] px-5 py-1"
          disableElevation
        >
          Cancel
        </Button>
        ...
        <Button
          onClick={hanadleSave}
          className="bg-[#19e6d1] text-black rounded-[12px] px-4 py-1"
          disableElevation
        >
          Save Task
        </Button>
